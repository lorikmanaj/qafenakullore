...
namespace QafenAkullAPI.Infrastructure.Migrations
{
    ...
    [Migration("20231116145307_Changed structure Cart and Wishlist")]
    partial class ChangedstructureCartandWishlist
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b945cd7e-e42f-4c25-beb7-96b98e7b88a8",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "2d4dd4ec-eaf8-4ffe-8f85-6112dfc8ed10",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("QafenAkullAPI.Domain.Entities.Product", b =>
                {
                    b.HasOne("QafenAkullAPI.Domain.Entities.ProductType", "Type")
                        .WithMany()
